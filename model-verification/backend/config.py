...
DPU_INANWP_DIR = os.getenv("DPU_INANWP_DIR", "/home/klimat/inanwp")
DPU_APPS_DIR = os.getenv("DPU_APPS_DIR", "/home/dpu/apps/model-verification")
...
VERIFY_PARAMETERS = {
    "precip_3h": {
        "label": "3-hour precipitation (METplus)",
        "unit": "mm",
        "category": "continuous",
        "methods": ["metplus"],
    },
    "temp_drybulb_c_tttttt": {"label": "2 m air temperature", "unit": "°C", "category": "continuous"},
    "temp_dewpoint_c_tdtdtd": {"label": "Dewpoint", "unit": "°C", "category": "continuous"},
    "relative_humidity_pc": {"label": "Relative humidity", "unit": "%", "category": "continuous"},
    "pressure_qff_mb_derived": {"label": "QFF pressure", "unit": "hPa", "category": "continuous"},
    "pressure_qfe_mb_derived": {"label": "QFE pressure", "unit": "hPa", "category": "continuous"},
    "wind_speed_ff": {"label": "Wind speed", "unit": "m/s", "category": "continuous"},
    "wind_dir_deg_dd": {"label": "Wind direction", "unit": "°", "category": "circular"},
    "rainfall_6h_rrr": {"label": "6-hour rainfall", "unit": "mm", "category": "continuous"},
    "rainfall_24h_rrrr": {"label": "24-hour rainfall", "unit": "mm", "category": "continuous"},
    "cloud_cover_oktas_m": {"label": "Cloud cover", "unit": "okta", "category": "continuous"},
    "visibility_vv": {"label": "Visibility", "unit": "km", "category": "continuous"},
    "temp_max_c_txtxtx": {"label": "Maximum temperature", "unit": "°C", "category": "continuous"},
    "temp_min_c_tntntn": {"label": "Minimum temperature", "unit": "°C", "category": "continuous"},
    "temp_wetbulb_c": {"label": "Wet-bulb temperature", "unit": "°C", "category": "continuous"},
    "pressure_reading_mb": {"label": "Station pressure reading", "unit": "hPa", "category": "continuous"},
    "rainfall_last_mm": {"label": "Latest rainfall", "unit": "mm", "category": "continuous"},
}
